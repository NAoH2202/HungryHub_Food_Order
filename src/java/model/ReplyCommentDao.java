...
public class ReplyCommentDao {
    ...
    public static ArrayList<ReplyComment> getAllReplyComments() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ReplyComment Repcomment = new ReplyComment(repcomment_id, account, comment, content, created_at, updated_at);
    ...
    public static boolean deleteReplyCommentById(int replyCommentId) {
        ConnectDB db = ConnectDB.getInstance();
        String query = "DELETE FROM [ReplyComment] WHERE replycomment_id = ?";
