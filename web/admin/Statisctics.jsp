    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="card-box">
                    <h4 class="header-title">Diner Statistics</h4>
                    ...
                    <div class="table-container">
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                <c:forEach items="${listDiners}" var="a">
                                    <tr>
                                        ...
                                        <td> <td>
                                        <form action="detail-statistic" method="GET">
                                            <input name="resturantId" type="hidden" value="${a.getAccount_id()}">
                                            <button type="submit" class="btn ban">Statistical</button>
                                        </form>
                                    </td></td>
                                    </tr>
                                </c:forEach>
