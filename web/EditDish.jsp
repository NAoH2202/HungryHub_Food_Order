...
<html>
    <head>
        ...
        <style>
            ...
            label {
                font-size: 1.2rem; /* Tăng cỡ chữ label */
            }
            .form-control {
                font-size: 1rem; /* Tăng cỡ chữ input */
            }
            .form-check-label {
                font-size: 1.2rem; /* Tăng cỡ chữ của checkbox label */
                margin-left: 10px; /* Căn chỉnh label cho đẹp */
            }
            .form-check-input {
                width: 25px; /* Tăng kích thước checkbox */
                height: 25px; /* Tăng kích thước checkbox */
            }
            .btn {
                font-size: 1.2rem; /* Tăng cỡ chữ của nút */
            }
        </style>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <%
                ...
                if (dish != null) {
                boolean dislocal = dish.isDislocal();
            %>
            <div class="edit-dish-container">
                <form action="UpdateDishServlet" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="dislocal" name="dislocal" <%= dish.isDislocal() ? "checked" : ""%>>
                        <label class="form-check-label" for="dislocal">Cannot deliver outside the city</label>
                    </div>
